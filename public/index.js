...
if (window.location.pathname === '/register') {
  ...
  __webpack_require__.e(/*! import() | codeSplit/code */ "codeSplit/code").then(__webpack_require__.bind(__webpack_require__, /*! ./components/generateCode/ */ "./resources/asset/js/components/generateCode/index.js")).then(function (module) {
    return module["default"];
  })["catch"](function (err) {
    return (0,_components_global__WEBPACK_IMPORTED_MODULE_0__.showError)(err);
  });
