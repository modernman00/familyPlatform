(self["webpackChunkfamily"] = self["webpackChunkfamily"] || []).push([["resources_asset_js_components_FormHelper_js"],{
      ...
      this.data.forEach(function (et) {
        ...
        try {
          for (_iterator.s(); !(_step = _iterator.n()).done;) {
            ...
            if (post.name == 'submit' || post.name == 'button' || post.name == 'token' || post.name == "checkbox_id") {
              continue;
