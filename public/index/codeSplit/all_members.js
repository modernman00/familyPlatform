...
document.onclick = function (e) {
  try {
    ...
    if (targetId.includes('addFamily')) {
      ...
      var fetchApproverData = /*#__PURE__*/function () {
        var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee() {
          var result, approverDetails, getRequesterDetails, requesterDetails, familyRequestMgt;
          return _regeneratorRuntime().wrap(function _callee$(_context) {
            while (1) switch (_context.prev = _context.next) {
              case 0:
                _context.prev = 0;
                _context.next = 3;
                return axios__WEBPACK_IMPORTED_MODULE_0___default().get("/members/familyRequestMgt/getApprover?id=".concat(removedAddFriendFromId));
              case 3:
                ...
                getRequesterDetails = localStorage.getItem('profile');
                requesterDetails = JSON.parse(getRequesterDetails);
                familyRequestMgt = {
        ...
        return function fetchApproverData() {
      ...
      var removedAddFriendFromId = targetId.replace("addFamily", "");
    }
  } catch (error) {
