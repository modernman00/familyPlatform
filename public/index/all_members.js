...
axios__WEBPACK_IMPORTED_MODULE_4__["default"].get(notificationURL).then(function (res) {
  (0,_global__WEBPACK_IMPORTED_MODULE_1__.log)(res, 'res');
...
document.onclick = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee(e) {
    var targetId, senderId, element, response, notificationCountValue, newValues;
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          _context.prev = 0;
          ...
          element = (0,_global__WEBPACK_IMPORTED_MODULE_1__.id)("notificationBar".concat(senderId));
        ...
        case 9:
          _context.next = 11;
          return axios__WEBPACK_IMPORTED_MODULE_4__["default"].put("/removeNotification/".concat(yourId, "/").concat(famCode, "/").concat(senderId));
        case 11:
          response = _context.sent;
          if (response.data.message === "success") {
            // remove a html element with notificationBar after 2 mins 
            setTimeout(function () {
              var element = (0,_global__WEBPACK_IMPORTED_MODULE_1__.id)("notificationBar".concat(senderId));
              if (element) element.remove();
            }, 4000);

            // reduce the notification count as you have deleted the notification
            notificationCountValue = (0,_global__WEBPACK_IMPORTED_MODULE_1__.id)('notification_count').innerHTML;
            newValues = parseInt(notificationCountValue - 1);
            (0,_global__WEBPACK_IMPORTED_MODULE_1__.id)('notification_count').innerHTML = newValues;
          }
        case 13:
          _context.next = 19;
          break;
