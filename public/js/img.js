...
/* harmony import */ var _modernman00_shared_js_lib__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! @modernman00/shared-js-lib */ "./node_modules/@modernman00/shared-js-lib/index.js");
...
(0,axios_retry__WEBPACK_IMPORTED_MODULE_3__["default"])(axios__WEBPACK_IMPORTED_MODULE_2__["default"], {
  retries: 3
});
    ...
    return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_1___default().wrap(function (_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          ...
          notificationId = (0,_modernman00_shared_js_lib__WEBPACK_IMPORTED_MODULE_5__.id)(notificationForm);
          if (notificationId) {
            _context.next = 1;
            break;
          }
        ...
        case 1:
          ...
          form = (0,_modernman00_shared_js_lib__WEBPACK_IMPORTED_MODULE_5__.id)(formId);
          if (form) {
            _context.next = 2;
            break;
          }
...
var processFormDataAction = function processFormDataAction(cssClass, message, formNotificationId) {
  if (formNotificationId) {
    ...
    var errorElement = (0,_modernman00_shared_js_lib__WEBPACK_IMPORTED_MODULE_5__.id)('error');
    if (errorElement) {
    ...
    var loader = (0,_modernman00_shared_js_lib__WEBPACK_IMPORTED_MODULE_5__.id)('setLoader');
    if (loader) loader.classList.remove('loader');
  } else {
    (0,_modernman00_shared_js_lib__WEBPACK_IMPORTED_MODULE_5__.log)('Notification element not found');
  }
};
...
var checkCookie = function checkCookie() {
  ...
  if (user != "") {
    sweetalert2__WEBPACK_IMPORTED_MODULE_4___default().fire("Welcome again " + user);
  } else {
