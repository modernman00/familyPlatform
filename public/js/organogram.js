...
var fitScreenBtn = (0,_shared__WEBPACK_IMPORTED_MODULE_0__.id)('fitScreenBtn');
var recenterRootBtn = (0,_shared__WEBPACK_IMPORTED_MODULE_0__.id)('recenterRootBtn');
...
var memberSearchInput = (0,_shared__WEBPACK_IMPORTED_MODULE_0__.id)('memberSearchInput');
var searchDropdown = (0,_shared__WEBPACK_IMPORTED_MODULE_0__.id)('searchDropdown');
...
memberSearchInput === null || memberSearchInput === void 0 ? void 0 : memberSearchInput.addEventListener('input', function (e) {
  ...
  var allNodes = Array.from(document.querySelectorAll('.tree-node'));
  ...
  matches.slice(0, 6).forEach(function (n) {
    ...
    var name = ((_n$querySelector = n.querySelector('.node-name')) === null || _n$querySelector === void 0 ? void 0 : (_n$querySelector$text = _n$querySelector.textContent) === null || _n$querySelector$text === void 0 ? void 0 : _n$querySelector$text.trim()) || 'Relative';
    var role = ((_n$querySelector2 = n.querySelector('.node-title')) === null || _n$querySelector2 === void 0 ? void 0 : (_n$querySelector2$tex = _n$querySelector2.textContent) === null || _n$querySelector2$tex === void 0 ? void 0 : _n$querySelector2$tex.trim()) || '';
    var img = ((_n$querySelector3 = n.querySelector('.profile-image')) === null || _n$querySelector3 === void 0 ? void 0 : _n$querySelector3.src) || '/resources/images/profile/avatarM.png';
    resultsHtml += "\n      <div class=\"search-result-item\" data-name=\"".concat(name, "\">\n        <img src=\"").concat(img, "\" alt=\"").concat(name, "\">\n        <div class=\"search-result-info\">\n          <div class=\"search-result-name\">").concat(name, "</div>\n          <div class=\"search-result-meta\">").concat(role, "</div>\n        </div>\n      </div>\n    ");
  });
...
searchDropdown === null || searchDropdown === void 0 ? void 0 : searchDropdown.addEventListener('click', function (e) {
  ...
  var targetElem = Array.from(document.querySelectorAll('.tree-node')).find(function (el) {
    return el.textContent.includes(targetName);
  });
  if (targetElem) {
    (0,_events__WEBPACK_IMPORTED_MODULE_1__.centerOnElement)(targetElem);
  }
});
...
var personModal = (0,_shared__WEBPACK_IMPORTED_MODULE_2__.id)('personModal');
var modalBody = (0,_shared__WEBPACK_IMPORTED_MODULE_2__.id)('modalBody');
var closeModal = (0,_shared__WEBPACK_IMPORTED_MODULE_2__.id)('closeModal');
...
var showPersonDetails = /*#__PURE__*/function () {
  var _ref = (0,_babel_runtime_helpers_asyncToGenerator__WEBPACK_IMPORTED_MODULE_0__["default"])(/*#__PURE__*/_babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_1___default().mark(function _callee(personData) {
    var _personData$fullName, fullName, _personData$email, email, _personData$img, img, _personData$relation, relation, _personData$maritalSt, maritalStatus, _personData$spouseNam, spouseName, _personData$occupatio, occupation, _personData$country, country, _personData$personId, personId, _personData$nodeId, nodeId, _personData$isRegiste, isRegistered, _personData$familyCod, familyCode, _personData$isDecease, isDeceased, _personData$bio, bio, targetModal, targetModalBody, inviteMessage, claimSpotHtml, closeActionBtn;
    return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_1___default().wrap(function (_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          _personData$fullName = personData.fullName, fullName = _personData$fullName === void 0 ? 'Family Member' : _personData$fullName, _personData$email = personData.email, email = _personData$email === void 0 ? '' : _personData$email, _personData$img = personData.img, img = _personData$img === void 0 ? '/resources/images/profile/avatarM.png' : _personData$img, _personData$relation = personData.relation, relation = _personData$relation === void 0 ? 'Relative' : _personData$relation, _personData$maritalSt = personData.maritalStatus, maritalStatus = _personData$maritalSt === void 0 ? '' : _personData$maritalSt, _personData$spouseNam = personData.spouseName, spouseName = _personData$spouseNam === void 0 ? '' : _personData$spouseNam, _personData$occupatio = personData.occupation, occupation = _personData$occupatio === void 0 ? '' : _personData$occupatio, _personData$country = personData.country, country = _personData$country === void 0 ? '' : _personData$country, _personData$personId = personData.personId, personId = _personData$personId === void 0 ? null : _personData$personId, _personData$nodeId = personData.nodeId, nodeId = _personData$nodeId === void 0 ? null : _personData$nodeId, _personData$isRegiste = personData.isRegistered, isRegistered = _personData$isRegiste === void 0 ? false : _personData$isRegiste, _personData$familyCod = personData.familyCode, familyCode = _personData$familyCod === void 0 ? '' : _personData$familyCod, _personData$isDecease = personData.isDeceased, isDeceased = _personData$isDecease === void 0 ? false : _personData$isDecease, _personData$bio = personData.bio, bio = _personData$bio === void 0 ? '' : _personData$bio;
          targetModal = (0,_shared__WEBPACK_IMPORTED_MODULE_2__.id)('personModal');
          targetModalBody = (0,_shared__WEBPACK_IMPORTED_MODULE_2__.id)('modalBody');
        ...
        case 1:
          ...
          closeActionBtn = (0,_shared__WEBPACK_IMPORTED_MODULE_2__.id)('modalCloseActionBtn');
...
var initModalClosers = function initModalClosers() {
  var modal = (0,_shared__WEBPACK_IMPORTED_MODULE_2__.id)('personModal');
  var closeBtn = (0,_shared__WEBPACK_IMPORTED_MODULE_2__.id)('closeModal');
