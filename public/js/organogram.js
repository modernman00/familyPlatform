  ...
  var _ref = (0,_babel_runtime_helpers_asyncToGenerator__WEBPACK_IMPORTED_MODULE_0__["default"])(/*#__PURE__*/_babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_1___default().mark(function _callee(personData) {
    ...
    return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_1___default().wrap(function (_context) {
      while (1) switch (_context.prev = _context.next) {
        ...
        case 1:
          inviteLink = "".concat(window.location.origin, "/register?famCode=").concat(encodeURIComponent(familyCode), "&name=").concat(encodeURIComponent(fullName));
          inviteMessage = encodeURIComponent("Hey ".concat(fullName, "! I just added you to our family tree on FamilyPlatform. Click here to join and explore our family lineage: ").concat(inviteLink));
