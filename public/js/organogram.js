...
var showPersonDetails = /*#__PURE__*/function () {
  var _ref = (0,_babel_runtime_helpers_asyncToGenerator__WEBPACK_IMPORTED_MODULE_0__["default"])(/*#__PURE__*/_babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_1___default().mark(function _callee(personData) {
    var _window$graphData;
    var _ref2, _ref2$fullName, fullName, _ref2$email, email, _ref2$img, img, _ref2$relation, relation, _ref2$maritalStatus, maritalStatus, _ref2$spouseName, spouseName, _ref2$occupation, occupation, _ref2$country, country, _ref2$personId, personId, _ref2$nodeId, nodeId, _ref2$isRegistered, isRegistered, _ref2$familyCode, familyCode, _ref2$isDeceased, isDeceased, _ref2$bio, bio, targetModal, targetModalBody, isSelf, cleanName, parts, deduped, i, inviteLink, nameParts, familySurname, inviteMessage, isReadOnly, claimSpotHtml, closeActionBtn, _document$querySelect, _document$querySelect2, csrfToken;
    return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_1___default().wrap(function (_context) {
      while (1) switch (_context.prev = _context.next) {
        ...
        case 1:
          ...
          isSelf = personId && String(personId) === String(window.__ROOT_USER_ID__) || nodeId && typeof window.getGraphNodeId === 'function' && String(nodeId) === String(window.getGraphNodeId(window.__ROOT_USER_ID__, ''));
        ...
        case 6:
          ...
          if (familyCode && !isReadOnly && !isRegistered) {
            csrfToken = ((_document$querySelect = document.querySelector('meta[name="csrf-token"]')) === null || _document$querySelect === void 0 ? void 0 : _document$querySelect.getAttribute('content')) || ((_document$querySelect2 = document.querySelector('input[name="token"]')) === null || _document$querySelect2 === void 0 ? void 0 : _document$querySelect2.value) || '';
            fetch('/api/invite/generate', {
              ...
              if (data.status === 'success' && data.invite_url) {
                var freshUrl = data.invite_url;
                var freshMsg = encodeURIComponent("\uD83C\uDF33 *Family Tree Invitation* \uD83C\uDF33\n\n" + "You are invited to connect with the *".concat(familySurname, " Family* on FamilyPlatform.\n\n") + "Click below to claim your spot, explore our lineage, and connect with the family:\n" + "\uD83D\uDC49 ".concat(freshUrl));
                var wBtn = (0,_modernman00_shared_js_lib__WEBPACK_IMPORTED_MODULE_2__.id)('treeClaimWhatsappBtn');
                var sBtn = (0,_modernman00_shared_js_lib__WEBPACK_IMPORTED_MODULE_2__.id)('treeClaimSmsBtn');
                var cBtn = (0,_modernman00_shared_js_lib__WEBPACK_IMPORTED_MODULE_2__.id)('treeClaimCopyBtn');
                if (wBtn) wBtn.href = "https://api.whatsapp.com/send?text=".concat(freshMsg);
                if (sBtn) sBtn.href = "sms:?body=".concat(freshMsg);
