    ...
    return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_1___default().wrap(function (_context) {
      while (1) switch (_context.prev = _context.next) {
        ...
        case 6:
          ...
          claimSpotHtml = !isRegistered && !isReadOnly ? "\n    <div class=\"claim-spot-section mt-4\" style=\"background: var(--gold-light); padding: 18px; border-radius: 18px; text-align: center; border: 1px dashed var(--gold-accent);\">\n      <h4 style=\"color: var(--primary-color); font-size: 1rem; font-weight: 700; margin-bottom: 6px;\">Invite Relative to Claim This Spot</h4>\n      <p style=\"font-size: 0.85rem; color: var(--text-muted); margin-bottom: 14px;\">Send a personal invitation so they can join and share family memories.</p>\n      <div style=\"display: flex; gap: 10px; justify-content: center; flex-wrap: wrap;\">\n        <a href=\"https://api.whatsapp.com/send?text=".concat(inviteMessage, "\" onclick=\"if(window.trackTreeAnalytics) window.trackTreeAnalytics('tree_invite_claim', null, { method: 'whatsapp' })\" target=\"_blank\" rel=\"noopener noreferrer\" class=\"btn\" style=\"background: #25D366; color: white; border-radius: 20px; padding: 8px 18px; font-size: 0.86rem; text-decoration: none; font-weight: 600;\">\n          <i class=\"bi bi-whatsapp\"></i> WhatsApp\n        </a>\n        <a href=\"sms:?body=").concat(inviteMessage, "\" onclick=\"if(window.trackTreeAnalytics) window.trackTreeAnalytics('tree_invite_claim', null, { method: 'sms' })\" class=\"btn\" style=\"background: var(--primary-color); color: white; border-radius: 20px; padding: 8px 18px; font-size: 0.86rem; text-decoration: none; font-weight: 600;\">\n          <i class=\"bi bi-chat-text\"></i> SMS\n        </a>\n        <button type=\"button\" onclick=\"if(window.copyInviteToClipboard) window.copyInviteToClipboard('").concat(inviteLink, "', this)\" class=\"btn btn-secondary\" style=\"border-radius: 20px; padding: 8px 18px; font-size: 0.86rem; font-weight: 600;\">\n          <i class=\"bi bi-clipboard-check\"></i> Copy Link\n        </button>\n      </div>\n    </div>\n  ") : ''; // Inject content into modal body — every field below is user-controlled
