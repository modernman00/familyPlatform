...
document.onclick = /*#__PURE__*/function () {
  var _ref = (0,_babel_runtime_helpers_asyncToGenerator__WEBPACK_IMPORTED_MODULE_0__["default"])(/*#__PURE__*/_babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_1___default().mark(function _callee(e) {
    var btn, targetId, userId, approverDetails, familyRequestData, result, _userId, currentReqId, url, _result, memberCard, response, container, remaining, countStr, memberCountBadge, memberCountDisplay, _response$data, errText, _err$response, _err$response$data, _errText, _userId2, _userId3, _t, _t2;
    return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_1___default().wrap(function (_context) {
      while (1) switch (_context.prev = _context.next) {
        ...
        case 4:
          ...
          currentReqId = localStorage.getItem('requesterId') || '';
          url = "/allMembers/removeProfile/".concat(_userId, "/").concat(currentReqId); // Confirm with SweetAlert warning modal
          _context.next = 5;
        ...
        case 5:
          ...
          return axios__WEBPACK_IMPORTED_MODULE_2__["default"].delete(url, {
            headers: {
              'X-CSRF-TOKEN': (0,_global_js__WEBPACK_IMPORTED_MODULE_5__.getCsrfToken)(),
              'X-XSRF-TOKEN': (0,_global_js__WEBPACK_IMPORTED_MODULE_5__.getCsrfToken)()
            }
          });
        case 7:
