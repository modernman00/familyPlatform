...
document.onclick = /*#__PURE__*/function () {
  var _ref = (0,_babel_runtime_helpers_asyncToGenerator__WEBPACK_IMPORTED_MODULE_0__["default"])(/*#__PURE__*/_babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_1___default().mark(function _callee(e) {
    var targetId, userId, approverDetails, familyRequestData, result, _userId, url, _result, notificationHTML, response, _userId2, _userId3, _t;
    ...
    return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_1___default().wrap(function (_context) {
      while (1) switch (_context.prev = _context.next) {
        ...
        case 3:
          ...
          _context.prev = 4;
          _context.next = 5;
          return axios__WEBPACK_IMPORTED_MODULE_3__["default"].post("/register/contactNewMember", postObj);
        case 5:
          response = _context.sent;
      ...
      return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_1___default().wrap(function (_context2) {
        while (1) switch (_context2.prev = _context2.next) {
          ...
          case 1:
            _context2.prev = 1;
            _context2.next = 2;
            return axios__WEBPACK_IMPORTED_MODULE_3__["default"].get(searchUrl, {
              params: {
                q: rawQuery
              }
            });
