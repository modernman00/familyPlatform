...
function profileFeed() {
  return {
    ...
    normalizePost(p) {
      ...
      if (rawImg) {
        profImg = rawImg.startsWith('/') || rawImg.startsWith('http') ? rawImg : "/public/img/profile/".concat(rawImg);
      }
      return {
    ...
    normalizeComment(c) {
      ...
      return {
        ...
        profileImg: img ? "/public/img/profile/".concat(img) : '/public/avatar/avatarM.png',
