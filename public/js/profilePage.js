  ...
  return {
        ...
        return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_4___default().wrap(function (_context2) {
          while (1) switch (_context2.prev = _context2.next) {
            case 0:
              ...
              _context2.prev = 1;
              _context2.next = 2;
              return axios__WEBPACK_IMPORTED_MODULE_8__["default"].get('/post/getAllPostCommentByFamCode');
            case 2:
              response = _context2.sent;
        ...
        return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_4___default().wrap(function (_context3) {
          while (1) switch (_context3.prev = _context3.next) {
            ...
            case 1:
              ...
              _context3.prev = 2;
              _context3.next = 3;
              return axios__WEBPACK_IMPORTED_MODULE_8__["default"].post('/postCommentProfile', formData, {
                headers: {
        ...
        return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_4___default().wrap(function (_context4) {
          while (1) switch (_context4.prev = _context4.next) {
            ...
            case 2:
              _context4.prev = 2;
              _context4.next = 3;
              return axios__WEBPACK_IMPORTED_MODULE_8__["default"]["delete"]("/post/".concat(postNo), _this5.csrfOptions);
            case 3:
        ...
        return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_4___default().wrap(function (_context5) {
          while (1) switch (_context5.prev = _context5.next) {
            ...
            case 1:
              _context5.prev = 1;
              _context5.next = 2;
              return axios__WEBPACK_IMPORTED_MODULE_8__["default"].put("/comment/".concat(commentNo), {
                comment: text
              }, _this6.csrfOptions);
            case 2:
        ...
        return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_4___default().wrap(function (_context6) {
          while (1) switch (_context6.prev = _context6.next) {
            ...
            case 2:
              _context6.prev = 2;
              _context6.next = 3;
              return axios__WEBPACK_IMPORTED_MODULE_8__["default"]["delete"]("/comment/".concat(commentNo), _this7.csrfOptions);
            case 3:
        ...
        return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_4___default().wrap(function (_context7) {
          while (1) switch (_context7.prev = _context7.next) {
            ...
            case 1:
              ...
              _context7.prev = 2;
              _context7.next = 3;
              return axios__WEBPACK_IMPORTED_MODULE_8__["default"].put('/profileCard/postLikes?postNo=' + postNo);
            case 3:
              _context7.next = 5;
              break;
            case 4:
        ...
        return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_4___default().wrap(function (_context8) {
          while (1) switch (_context8.prev = _context8.next) {
            ...
            case 2:
              ...
              _context8.next = 4;
              return axios__WEBPACK_IMPORTED_MODULE_8__["default"].post('/api/reactions/add', formData, {
                headers: {
                  'Content-Type': 'multipart/form-data'
                }
              });
    ...
    votePoll(postNo, optionId) {
      ...
      return (0,_babel_runtime_helpers_asyncToGenerator__WEBPACK_IMPORTED_MODULE_3__["default"])(/*#__PURE__*/_babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_4___default().mark(function _callee0() {
        var post, snapshot, voted, already, total, _response$data3, _response$data4, formData, response, _response$data5, _t0;
        return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_4___default().wrap(function (_context0) {
          while (1) switch (_context0.prev = _context0.next) {
            ...
            case 1:
              ...
              formData.append('option_id', optionId);
              _context0.next = 3;
              return axios__WEBPACK_IMPORTED_MODULE_8__["default"].post('/api/poll/vote', formData, {
                headers: {
                  'Content-Type': 'multipart/form-data'
                }
              });
