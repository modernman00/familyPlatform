...
var renderEmojiList = function renderEmojiList(emojis, emojiContainerId, emojiTargetDataClass) {
  ...
  var emojiTarget = document.querySelector("[".concat(emojiTargetDataClass, "]")); // Where emojis will be inserted
