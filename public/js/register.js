...
btnFamCode.addEventListener("click", function () {
  ...
  try {
    ...
    if (surnameEl && surnameEl.value !== "") {
      var rawSurname = (surnameEl.value || '').replace(/[^A-Za-z]/g, '');
      var prefix = rawSurname.substring(0, 3).toUpperCase();
      if (prefix.length < 3) {
        prefix = prefix.padEnd(3, 'X');
      }
      var randomThreeDigits = Math.floor(100 + Math.random() * 900);
      (0,_shared__WEBPACK_IMPORTED_MODULE_2__.id)('createCode').value = "".concat(prefix).concat(randomThreeDigits);
    ...
    return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_1___default().wrap(function (_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          ...
          _context.next = 1;
          return axios__WEBPACK_IMPORTED_MODULE_3__["default"].post('/register/checkContact', payload);
        case 1:
          response = _context.sent;
...
(0,_kidsAndSiblings__WEBPACK_IMPORTED_MODULE_4__.processKidsSiblings)(fName);
