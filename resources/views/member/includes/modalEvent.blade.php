<div id="id_event_modal" class="w3-modal">
  ...
  <div class="w3-modal-content w3-card-4 w3-animate-zoom" style="max-width:600px">
    ...
    <div class="w3-center"><br>
      <span id="cancelModal" class="w3-button w3-xlarge w3-hover-red w3-display-topright" title="Close Modal">&times;</span>
    </div>



    <form class="w3-container eventModalForm" action="" id='eventModalForm' method="post" enctype='multipart/form-data'>

      <div class="w3-row w3-section">
        <div class="w3-col" style="width:50px"><em class="w3-xxlarge fa fa-glass"></em></div>
        <div class="w3-rest">
          <input class="w3-input w3-border" name="eventName" id="eventName" type="text" placeholder="Event Name">
      ...
      <div class="w3-row w3-section">
        ...
        <div class="w3-rest">
          <input class="w3-input w3-border" name="eventDescription" type="text" placeholder="Describe what the event is all about" id="eventDescription">
