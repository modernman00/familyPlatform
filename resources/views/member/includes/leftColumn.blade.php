        <div class="profile-column">
            <div class="card profile-card text-center">
                <div class="card-header position-relative">
                    <div class="cover-photo" style="height: 100px; background-color: #0a526f; border-radius: 8px 8px 0 0;"></div>
        ...
        {{ $data['lastName'] }}  </h5>
                    ...
                    <button class="btn btn-outline-primary w-100" data-bs-toggle="modal" data-bs-target="#createEventModal">
