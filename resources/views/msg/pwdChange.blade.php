...
<div style="text-align: center; margin-top: 30px;">
    <a href="{{ getenv('MIX_APP_URL2') }}login" style="background-color: var(--brand-primary); color: #ffffff; padding: 12px 24px; text-decoration: none; border-radius: 6px; font-weight: 600; display: inline-block;">Login to Account</a>
</div>
@endsection