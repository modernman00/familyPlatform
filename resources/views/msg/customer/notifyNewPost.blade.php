...
<div style="text-align: center;">
    <a href="{{ getenv('MIX_APP_URL2') }}profilePage" style="background-color: #00bfa5; color: #ffffff; padding: 12px 28px; text-decoration: none; border-radius: 6px; font-weight: 600; display: inline-block;">View Post</a>
</div>
@endsection
