...
<div style="background-color: #f8fafc; border-left: 4px solid var(--brand-primary); padding: 20px; border-radius: 4px; margin-bottom: 25px; font-style: italic; color: #475569;">
...
<div style="text-align: center;">
    <a href="{{ getenv('MIX_APP_URL2') }}profilePage" style="background-color: var(--brand-primary); color: #ffffff; padding: 12px 28px; text-decoration: none; border-radius: 6px; font-weight: 600; display: inline-block;">View Post</a>
</div>
@endsection
