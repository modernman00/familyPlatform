...
<head>
    ...
    <title>Reset Password | FamilyPlatform Admin</title>
    <style>
        :root {
            --bg-dark: #0f172a;
            --bg-card: #1e293b;
...
<body>
    <div class="auth-card">
        <div class="brand">Create New Master Password</div>
        <p class="subtitle">Choose a strong password for your FamilyPlatform admin account. Minimum 8 characters.</p>
        ...
        <form method="POST" action="{{ $adminPrefix }}/reset-password" autocomplete="off">
